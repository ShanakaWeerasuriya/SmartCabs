<%@ Page Title="" Language="C#" MasterPageFile="~/Registration/Register.Master" AutoEventWireup="true" CodeBehind="DriverRegistration.aspx.cs" Inherits="SmartCabs.Registration.WebForm2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Body_PlaceHolder" runat="server">
    ...
    <form id="form1" runat="server">
        ...
        <div class="form-horizontal form-control-sm">
            <h4>Create a new  Driver Account</h4>
            <hr />
            <asp:ValidationSummary runat="server" CssClass="text-danger" />

             <div class="form-group">
                <asp:Label runat="server" AssociatedControlID="txtDriverName" CssClass="col-sm-12 control-label">User Name</asp:Label>
                <div class="col-md-10">
                    <asp:TextBox runat="server" ID="txtDriverName" CssClass="form-control form-control-sm" />
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="txtDriverName"
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <asp:DropDownList  runat="server" ID="cmbVehicleType" CssClass="form-control form-control-sm"></asp:DropDownList>
             ...
             <div class="form-group">
                <asp:Label runat="server" AssociatedControlID="txtVehicleNumber" CssClass="col-sm-12 control-label">Vehicle Number</asp:Label>
                <div class="col-md-10">
                    <asp:TextBox runat="server" ID="txtVehicleNumber"  CssClass="form-control form-control-sm" />
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="txtVehicleNumber"
                        CssClass="text-danger" ErrorMessage="The Vehicle Number is required." />
                </div>
            </div>

            <div class="form-group">
                <asp:Label runat="server" AssociatedControlID="txtVehicleDesc" CssClass="col-sm-12 control-label">Vehicle Description</asp:Label>
                <div class="col-md-10">
                    <asp:TextBox runat="server" ID="txtVehicleDesc"  CssClass="form-control form-control-sm" />
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="txtVehicleDesc"
                        CssClass="text-danger" ErrorMessage="The Vehicle Description is required." />
                </div>
            </div>
